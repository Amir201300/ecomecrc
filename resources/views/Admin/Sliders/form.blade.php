            ...
            <form id="formSubmit">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="example-email">اسم الزر بالعربيه</label>
                                <input type="text" id="button_name_ar" name="button_name_ar" required class="form-control"   >
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="example-email">اسم الزر بالانجليزيه</label>
                                <input type="text" id="button_name_en" name="button_name_en"  class="form-control"   >
                            </div>
                        </div>
