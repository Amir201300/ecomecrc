...
<script type="text/javascript">
    ...
    var table = $('#datatable').DataTable({
        ...
        columns: [
            ...
            {data: 'button_name_ar', name: 'button_name_ar'},
            {data: 'button_name_en', name: 'button_name_en'},
    ...
    function editFunction(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#button_name_ar').val(data.button_name_ar);
                $('#button_name_en').val(data.button_name_en);
...
<script>
    function ChangeStatus(status,id) {
        ...
        $.ajax({
            url : '/Admin/Sliders/ChangeStatus/' +id +'?status='+status,
            type : 'get',
            success : function(data){
                $.toast().reset('all');
                table.ajax.reload();
